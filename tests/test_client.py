...
from computer import Computer, AsyncComputer, APIResponseValidationError
from computer._types import Omit
from computer._utils import asyncify
from computer._models import BaseModel, FinalRequestOptions
from computer._exceptions import ComputerError, APIStatusError, APITimeoutError, APIResponseValidationError
from computer._base_client import (
    DEFAULT_TIMEOUT,
...
class TestComputer:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "computer/_legacy_response.py",
                        "computer/_response.py",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Computer(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("computer._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
...
class TestAsyncComputer:
    ...
    def test_base_url_trailing_slash(self, client: AsyncComputer) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncComputer) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncComputer) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncComputer(base_url=base_url, api_key=api_key, _strict_response_validation=False)
