...
```python
from tzafon.types.computers import ExecExecuteResponse, ExecExecuteSyncResponse
```

Methods:

- <code title="post /computers/{id}/exec">client.computers.exec.<a href="./src/tzafon/resources/computers/exec.py">execute</a>(id, \*\*<a href="src/tzafon/types/computers/exec_execute_params.py">params</a>) -> <a href="./src/tzafon/types/computers/exec_execute_response.py">JSONLDecoder[ExecExecuteResponse]</a></code>
- <code title="post /computers/{id}/exec/sync">client.computers.exec.<a href="./src/tzafon/resources/computers/exec.py">execute_sync</a>(id, \*\*<a href="src/tzafon/types/computers/exec_execute_sync_params.py">params</a>) -> <a href="./src/tzafon/types/computers/exec_execute_sync_response.py">ExecExecuteSyncResponse</a></code>
