...
- <code title="get /auth/callback">client.auth.<a href="./src/tzafon/resources/auth.py">handle_callback</a>(\*\*<a href="src/tzafon/types/auth_handle_callback_params.py">params</a>) -> <a href="./src/tzafon/types/auth_handle_callback_response.py">AuthHandleCallbackResponse</a></code>
- <code title="get /auth/login">client.auth.<a href="./src/tzafon/resources/auth.py">initiate_login</a>() -> None</code>
- <code title="post /auth/logout">client.auth.<a href="./src/tzafon/resources/auth.py">logout</a>() -> <a href="./src/tzafon/types/auth_logout_response.py">AuthLogoutResponse</a></code>
- <code title="get /auth/me">client.auth.<a href="./src/tzafon/resources/auth.py">retrieve_current_user</a>() -> <a href="./src/tzafon/types/auth_retrieve_current_user_response.py">AuthRetrieveCurrentUserResponse</a></code>
...
- <code title="post /computers/{id}/screenshot">client.computers.<a href="./src/tzafon/resources/computers.py">take_screenshot</a>(id) -> <a href="./src/tzafon/types/action_result.py">ActionResult</a></code>
